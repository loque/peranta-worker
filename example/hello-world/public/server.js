...
/***/ function(module, exports, __webpack_require__) {
	...
	const Server = module.exports = function Server(transport)
	{
	    ...
	    // listen to the http-verbs channel
	    this.transport.on(channels.HTTP, (event, request) =>
	    {
	        let response = new Response()
	        response.ipc = { channel: channels.HTTP, sender: event.sender }
	...
	function createOutputHandler(outputHandlerName)
	{
	    if (typeof this.transport[outputHandlerName] == 'function')
	    {
	        this[outputHandlerName] = function (url, body)
	        {
	            ...
	            this.transport[outputHandlerName](channels.EVENT, response)
	        }
	    }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Route = module.exports = function Route(method, path, regexpOptions = {})
	{
	    ...
	    this.params = {}
	    this.baseUrl
	    this.pathMatcher = createPathMatcher(path, regexpOptions)
	...
	Route.prototype.handle = function handle(req, res, routerNext)
	{
	    ...
	    function next(err)
	    {
	        ...
	        // {
	        //     let fnMethods = Object.keys(handler)
	...
	function createPathMatcher(path, options)
	{
	    options = options || {}
